...
int QuestionSum (enLevelGame Level ,enOperationType OperationType, short FirstNumber, short SecondNumber) {
    ...
    short Sum = 0;
   // Part Easy.
   if (Level == enLevelGame::Easy && OperationType == enOperationType::Add) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == enLevelGame::Easy && OperationType == enOperationType::Subtraction) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == enLevelGame::Easy && OperationType == enOperationType::Multiplication) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == enLevelGame::Easy && OperationType == enOperationType::Division) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == enLevelGame::Easy && OperationType == enOperationType::MiX) {
   ...
   // Part Medium.
   else if (Level == enLevelGame::Medium && OperationType == enOperationType::Add) {
   ...
   else if (Level == enLevelGame::Medium && OperationType == enOperationType::Subtraction) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == enLevelGame::Medium && OperationType == enOperationType::Multiplication) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == enLevelGame::Medium && OperationType == enOperationType::Division) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == enLevelGame::Medium && OperationType == enOperationType::MiX) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;
   }
   // Part Hard.
   else if (Level == enLevelGame::Hard && OperationType == enOperationType::Add) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == enLevelGame::Hard && OperationType == enOperationType::Subtraction) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == enLevelGame::Hard && OperationType == enOperationType::Multiplication) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == enLevelGame::Hard && OperationType == enOperationType::Division) {
   ...
   // Part Mix.
   else if (Level == (enLevelGame)Random_Number(1, 4) && enOperationType::Add) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == (enLevelGame)Random_Number(1, 4) && enOperationType::Subtraction) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == (enLevelGame)Random_Number(1, 4) && enOperationType::Multiplication) {

    PrintQuestion(OperationType, FirstNumber, SecondNumber);
    cin >> Sum;

   }
   else if (Level == (enLevelGame)Random_Number(1, 4) && enOperationType::Division) {
